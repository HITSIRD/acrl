...
from deep_sprl.teachers.acrl import ACRL, ACRLWrapper
...
from deep_sprl.teachers.sampler import Subsampler, MinigridSampler
from scipy.stats import multivariate_normal

from deep_sprl.teachers.acrl.config import config
...
class MinigridBExperiment(AbstractExperiment):
    ...
    ACRL_LSP_RATIO = config['new_ratio']
    ACRL_EBU_RATIO = config['ls_ratio']
