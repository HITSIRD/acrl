...
register(
    id="MiniGrid-A-v1",
    entry_point="deep_sprl.environments.minigrid.envs:AEnv",
    kwargs={"size": 10},
)

register(
    id="MiniGrid-B-v1",
    entry_point="deep_sprl.environments.minigrid.envs:BEnv",
    kwargs={"size": 10},
)

register(
    id="MiniGrid-C-v1",
    entry_point="deep_sprl.environments.minigrid.envs:CEnv",
    kwargs={"size": 16},
)
...
for name_t in all_name:
    ...
    for Test in ['', 'Test', 'Test1', 'Test2']:
        ...
        register(
            id=name_t + Test + '-v0',
            entry_point='deep_sprl.environments.mujoco.create_maze_env:create_maze_env',
