...
from acrl.teachers.plr import PLR, PLRWrapper, ValueFunction
from acrl.teachers.vds import VDS, VDSWrapper
from acrl.environments.maze import MazeEnv
...
class MazeExperiment(AbstractExperiment):
    ...
    TARGET_MEANS = np.array([0., 5.])
    TARGET_VARIANCES = np.array([0.1, 0.1])
