...
config = {
    # --- CURRICULUM ---
    'step_size': 0.9,
    'return_delta': -300,  # select traj sample which return is greater than return_delta
    'update_delta': -200,  # if mean of return > update_delta, then update context dist
    'target_return_threshold': -150,
