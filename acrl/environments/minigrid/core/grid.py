...
from acrl.environments.minigrid.core.constants import OBJECT_TO_IDX, TILE_PIXELS
from acrl.environments.minigrid.core.world_object import Wall, WorldObj
from acrl.environments.minigrid.utils.rendering import (
    downsample,
    fill_coords,
    highlight_img,
    point_in_rect,
