...
from acrl.environments.mujoco_maze import maze_env_utils, maze_task
from acrl.environments.mujoco_maze.agent_model import AgentModel
...
class MazeEnv(gym.Env):
    def __init__(
        ...
        self.worldbody = tree.find(".//worldbody")
        ...
        self.set_goals(maze_size_scaling)
    ...
    def set_goals(self, maze_size_scaling):
        # Set goals
    ...
    def reset(self, context=None, **kwargs):
        self.t = 0
        ...
        if context is not None:
            ...
            self.set_goals(self._maze_size_scaling)
    ...
    def render(self, mode="human", **kwargs) -> Optional[np.ndarray]:
        if mode == "human" and self._websock_port is not None:
            if self._mj_offscreen_viewer is None:
                ...
                from acrl.environments.mujoco_maze.websock_viewer import start_server
