...
from acrl.environments.mujoco_maze.maze_env_utils import MazeCell
...
class MazeTask(ABC):
    ...
    def set_goal(self, goal):
        self.goals = [MazeGoal(np.array(goal))]
...
class GoalRewardHMaze(MazeTask):
...
class DistRewardHMaze(GoalRewardHMaze, DistRewardMixIn):
    pass
...
class TaskRegistry:
    REGISTRY: Dict[str, List[Type[MazeTask]]] = {
        ...
        "HMaze": [DistRewardHMaze, GoalRewardHMaze],
