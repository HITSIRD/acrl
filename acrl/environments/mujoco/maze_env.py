...
class MazeEnv(gym.Env):
    ...
    def __init__(
        ...
        for i in range(len(structure)):
            for j in range(len(structure[0])):
                ...
                if struct == 1:  # Unmovable block.
                    ...
                    if self.not_thin or (i == 0 or i == len(structure) - 1) or (
                            j == 0 or j == len(structure[0]) - 1) or maze_id != "Maze1":
        ...
        self.EPS = self.unwrapped.MAZE_SIZE_SCALING ** 2 / 16
